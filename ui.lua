...
local function build()
    ...
    do
        ...
        for _, tier in ipairs({ "raid", "mplus", "custom" }) do
            ...
            b.gdot = b:CreateTexture(nil, "OVERLAY"); b.gdot:SetSize(10, 10); b.gdot:SetTexture("Interface\\COMMON\\Indicator-Green"); b.gdot:SetPoint("LEFT", b.t, "RIGHT", 4, 0); b.gdot:Hide()
    ...
    local function getT2(i)
        ...
        if not b then
            ...
            b.t = fs(b, 11, TEXT)
            b.bar = b:CreateTexture(nil, "OVERLAY"); b.bar:SetPoint("BOTTOMLEFT", 1, 1); b.bar:SetPoint("BOTTOMRIGHT", -1, 1); b.bar:SetHeight(3); b.bar:SetColorTexture(GREEN[1], GREEN[2], GREEN[3], 0.95); b.bar:Hide()
            b.gdot = b:CreateTexture(nil, "OVERLAY"); b.gdot:SetSize(10, 10); b.gdot:SetTexture("Interface\\COMMON\\Indicator-Green"); b.gdot:SetPoint("LEFT", b.t, "RIGHT", 3, 0); b.gdot:Hide()
